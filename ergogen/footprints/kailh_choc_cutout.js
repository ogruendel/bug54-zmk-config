module.exports = {
    ...
    body: p => {
        ...
        const back_contents = `
            ...
            (fp_line (start -1.792467 -8.525) (end 2.625 -8.525) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
            (fp_line (start -1.5 -3.75) (end 1.35 -3.75) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
            (fp_line (start 2.475 -4.875) (end 4.625 -4.875) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
            (fp_line (start 2.625 -7.225) (end 2.625 -8.525) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
            (fp_line (start 4.625 -7.225) (end 2.625 -7.225) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
            ...
            (fp_arc (start 1.35 -4.875) (end 2.475 -4.875) (angle 90) (stroke (width 0.1) (type default)) (layer "B.SilkS"))
