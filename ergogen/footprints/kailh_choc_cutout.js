module.exports = {
    ...
    body: p => {
        ...
        const front_contents = `
            ...
            (fp_line (start -4.625 -7.225) (end -2.725 -7.225) (stroke (width 0.1) (type solid)) (layer "F.SilkS"))
            (fp_line (start -2.725 -7.225) (end -2.725 -8.525) (stroke (width 0.1) (type solid)) (layer "F.SilkS"))
            (fp_line (start -2.725 -4.875) (end -4.625 -4.875) (stroke (width 0.1) (type solid)) (layer "F.SilkS"))
            (fp_line (start 1.5 -3.75) (end -1.6 -3.75) (stroke (width 0.1) (type solid)) (layer "F.SilkS"))
            (fp_line (start 1.792467 -8.525) (end -2.725 -8.525) (stroke (width 0.1) (type solid)) (layer "F.SilkS"))
            ...
            (fp_arc (start -1.6 -4.875) (end -1.6 -3.75) (angle 90) (stroke (width 0.1) (type default)) (layer "F.SilkS"))
        ...
        const back_contents = `
            (fp_line (start -9.846492 -5.025) (end -9.846492 -2.675) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
            (fp_line (start -9.846492 -5.025) (end -7.696492 -5.025) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
            (fp_line (start -9.846492 -2.675) (end -7.696492 -2.675) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
            (fp_line (start -7.696492 -5.675) (end -7.020746 -6.350746) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
            (fp_line (start -7.696492 -5.025) (end -7.696492 -5.675) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
            (fp_line (start -7.696492 -2.675) (end -7.696492 -1.549254) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
            (fp_line (start -7.696492 -1.549254) (end -3.170746 -1.549254) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
            (fp_line (start -7.020746 -6.350746) (end -4.670746 -6.350746) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
            ...
            (fp_line (start -1.792467 -8.525) (end 2.725 -8.525) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
            (fp_line (start -1.5 -3.75) (end 1.6 -3.75) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
            (fp_line (start 2.725 -7.225) (end 2.725 -8.525) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
            (fp_line (start 2.725 -4.875) (end 4.625 -4.875) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
            (fp_line (start 4.625 -7.225) (end 2.725 -7.225) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
            (fp_line (start 4.625 -7.225) (end 4.625 -4.875) (stroke (width 0.1) (type solid)) (layer "B.SilkS"))
            (fp_arc (start -1.82387 -7.60363) (end -2.695125 -7.905002) (angle 72.8697) (stroke (width 0.1) (type default)) (layer "B.SilkS"))
            (fp_arc (start -4.67075 -8.38349) (end -2.695126 -7.905002) (angle 76.3852) (stroke (width 0.1) (type default)) (layer "B.SilkS"))
            (fp_arc (start -1.5 -2.85) (end -2.4 -2.85) (angle 90) (stroke (width 0.1) (type default)) (layer "B.SilkS"))
            (fp_arc (start 1.6 -4.875) (end 2.725 -4.875) (angle 90) (stroke (width 0.1) (type default)) (layer "B.SilkS"))
